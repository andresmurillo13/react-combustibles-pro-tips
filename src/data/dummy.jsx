...
const employeedGridStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: props.isActive ? '#8BE78B' : 'red' }} className="rounded-full h-3 w-3" />
